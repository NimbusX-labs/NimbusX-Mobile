...
const SecuritySettingsScreen = () => {
  ...
  const { appLockEnabled, appLockPin, securityNotifications, twoFactorEnabled } = useAppSelector(
  ...
  const encryptionParams = [
    { label: 'E2EE Status', value: 'Active (Always On)' },
    { label: 'Encryption Algorithm', value: 'XSalsa20-Poly1305' },
    { label: 'Key Exchange', value: 'ECDH (Curve25519)' },
    { label: 'Your Public Key', value: currentUser?.publicKey ? `${currentUser.publicKey.substring(0, 16)}...` : 'Not Loaded' },
          ...
          <View style={styles.modalContent}>
            ...
            {twoFactorStep === 2 && (
              <View style={styles.wizardContent}>
                ...
                <TextInput
                  style={[styles.pinInput, styles.verifyPinInput]}
                  keyboardType="number-pad"
                  maxLength={6}
                  value={authCode}
            ...
            {twoFactorStep === 3 && (
              <ScrollView contentContainerStyle={styles.wizardContent}>
                ...
                <View style={[styles.keyBox, { borderColor: colors.success }]}>
                  <Text style={[styles.keyValue, styles.recoveryKeyText, { color: colors.success }]}>
